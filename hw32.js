...
console.log("Задание 3.2. Ответ: " + f(1, 2, 3)); // 6
console.log("Задание 3.2. Ответ: " + f(1, 1, 1, 1, 1, 1, 1, 1)); // 8
console.log("Задание 3.2. Ответ: " + f(1, 2, 's', 4)); // Error: all parameters should be a Number type
